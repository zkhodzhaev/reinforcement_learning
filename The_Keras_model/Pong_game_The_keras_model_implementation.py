...
# Environment setup
env = CustomEnvWrapper(gym.make("ALE/Pong-v5"))
...
checkpoint_callback = ModelIntervalCheckpoint('The_keras_model.h5', interval=25000)
dqn.fit(env, nb_steps=NB_STEPS, visualize=False, verbose=2, callbacks=[checkpoint_callback])
